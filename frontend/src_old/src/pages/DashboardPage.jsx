  ...
  return (
    <Layout>
      <div className="flex flex-row justify-between">
        ...
        <div className="right-6 flex gap-5 z-50 items-center justify-center">
          ...
          <div className="group relative pb-2 flex flex-col items-center">
            <button
              type="button"
              className="px-4 py-2 bg-gradient-to-r from-red-400 to-red-700 rounded-full flex items-center justify-center hover:ring-2 
              hover:ring-red-600 
              hover:ring-offset-2 transition"
              onClick={() =>
                handleLogout()
